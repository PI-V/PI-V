...
const initialData: ColumnType[] = [
    ...
    cards: [
      {
        ...
        description: "Set up Next.js with Tailwind CSS",
      },
      {
        id: "card-2",
  ...
  },
  {
    ...
    cards: [
      {
        id: "card-4",
        content: "Develop Kanban board",
        description: "Create the main Kanban board component",
      },
      {
        id: "card-5",
        content: "Add column management",
        description: "Implement adding and editing columns",
      },
    ],
  },
  {
